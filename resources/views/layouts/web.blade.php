...
<head>
		...
		<link rel="stylesheet" href="{{ asset('vendor/font-awesome/css/font-awesome.min.cs') }}s">
		...
		<link rel="stylesheet" href="{{ asset('web/css/theme-shop.cs') }}s">


		<!-- Skin CSS -->
		<link rel="stylesheet" href="{{ asset('web/css/skins/default.css') }}">

		<!-- Theme Custom CSS -->
		<link rel="stylesheet" href="{{ asset('web/css/custom.css') }}">

		<!-- Head Libs -->
		<script src="{{ asset('web/vendor/modernizr/modernizr.min.js') }}"></script>
</head>
	<body>
		<div class="body">
			...
			<div role="main" class="main">
				...
				<div class="container">
					...
					<h2><strong>Full</strong> Width Page</h2>
		...
		<script src="{{ asset('web/vendor/jquery.appear/jquery.appear.min.js') }}"></script>
		<script src="{{ asset('web/vendor/jquery.easing/jquery.easing.min.js') }}"></script>
		<script src="{{ asset('web/vendor/jquery-cookie/jquery-cookie.min.js') }}"></script>
		<script src="{{ asset('web/vendor/popper/umd/popper.min.js') }}"></script>
		<script src="{{ asset('web/vendor/bootstrap/js/bootstrap.min.js') }}"></script>
		<script src="{{ asset('web/vendor/common/common.min.js') }}"></script>
